...
const tutorialSteps = [
  { title: "Willkommen!", text: "Willkomme bem E-Commerce Spiel! Hier lernst du alles über den Beruf Kaufmann/-frau im E-Commerce. Verrate uns bitte deinen Namen für deinen Shop, damit wir personalisiert starten können.", action: "Name bestätigen", isNameInput: true },
  { title: "Deine Mission", text: "Deine Mission ist es, erfolgreich eine Produktseite aufzubauen! Du wirst Schritt für Schritt lernen, was alles auf einer Produktseite sein sollte, Produkte für Suchmaschinen optimiern, überzeugende Verkaufstexte schreibt und einen komplette Produkseite gestalten. Alles basiert auf echten E-Commerce-Praktiken und Berufsinhalten.", action: "Verstanden" },
  { title: "5 Missionen", text: "Das Spiel besteht aus 5 aufeinander aufbauenden Missionen: 1) Produkt auswahl - Lege ein Produkt an, 2) SEO-Strategie - Optimiere für Suchmaschinen, 3) Conversion-Power - Schreibe verkaufsfördernde Texte, 4) Shop Builder - Gestalte deinen eigenen Shop, 5) Abschluss - Erhalte dein Zertifikat. Jede Mission schaltet die nächste frei.", action: "Weiter" },
