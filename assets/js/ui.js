...
function showInfo(type) {
  const infoData = {
    productName: {
      ...
      text: "Ein guter SEO-Name ist wie ein Schild an einem Geschäft: Er muss sofort sagen, was drin ist. Das Haupt-Keyword ist das wichtigste Wort – also genau das Wort, das Kunden bei Google eintippen würden. Dieses Wort sollte immer ganz am Anfang stehen. Danach schreibst du ein besonderes Merkmal dazu, damit dein Produkt besser klingt als die anderen. Beispiel: Statt nur „Lampe\" schreibst du „LED Lampe mit Farbwechsel und Fernbedienung\". So verstehen Kunden und Google sofort, was dein Produkt besonders macht."
    },
    productDescription: {
      title: "Produktbeschreibung",
      text: "Die Produktbeschreibung ist dein Verkäufer im Internet. Sie muss den Kunden überzeugen, ohne dass jemand nachfragen kann. Erkläre klar, was das Produkt kann und warum es sich lohnt. Zeige deinen USP (Unique Selling Point), also das, was dein Produkt einzigartig macht und von anderen unterscheidet. Nutze einladende Sprache und baue passende Suchwörter natürlich ein, damit Google dein Produkt besser findet."
    },
    metaTitle: {
      title: "Meta Titel",
    ...
    productVat: {
      ...
      text: "Die Mehrwertsteuer ist im Verkaufspreis enthalten. In Deutschland gilt meistens 19 Prozent. Für manche Produkte gilt 7 Prozent, zum Beispiel für Lebensmittel, Bücher und auch medizinische Hilfsmittel. Wähle den Steuersatz, der zu deinem Produkt passt. Der angegebene Preis sollte der Bruttopreis sein, also inklusive MwSt."
    },
    productSelect: {
      title: "Produktauswahl",
      text: "Überlege dir zuerst, welches Produkt du in deinem Online-Shop verkaufen möchtest. Die Wahl ist wichtig, denn je nach Produkt sprechen wir andere Kunden an und nutzen andere Begriffe. Schau dir die Liste an und wähle ein Produkt aus, das dich interessiert. Danach geht es Schritt für Schritt darum, wie du es richtig präsentierst, damit Kunden es im Internet finden und kaufen möchten."
    },
    seoBuilder: {
    ...
    conversionText: {
      ...
      text: "Ein Conversion Text hilft dabei, Besucher zu einer Handlung zu führen, zum Beispiel zum Kauf oder zum Warenkorb. Er sollte klar erklären, welchen Nutzen das Produkt hat und warum es zum Kunden passt. Wichtig sind verständliche Vorteile, Vertrauen und eine einfache Sprache."
    }
  };
